function paramMap_GUI(outputDir, update_measurements)
...
%   >> paramMap_GUI(outputDir, true)  % Regenerates LOCs and updates tables
%
% Inputs:
...
%   update_measurements (optional) - If true, regenerates LOCs and updates
%                                    saved tables (SummaryParamTool.xls, LabelsQVT.csv)
%                                    without running the full pipeline. Default: false.
    ...
    if update_measurements
        ...
        try
            ...
            warning('paramMap_GUI:UpdateFailed', ...
                    'Failed to update measurements: %s', ME.message);
        end
    end
